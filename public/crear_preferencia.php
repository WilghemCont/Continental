...
try {
    $preference = $client->create([
        ...
        "back_urls" => [
            "success" => "https://dubiously-coastline-shove.ngrok-free.dev/continental/public/success.php",
            "failure" => "https://dubiously-coastline-shove.ngrok-free.dev/continental/public/failure.php",
        ],
